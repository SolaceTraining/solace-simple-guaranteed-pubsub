...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceTraining/solace-simple-guaranteed-pubsub/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/SolaceTraining/solace-simple-guaranteed-pubsub/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Search [GitHub](https://github.com/SolaceTraining/solace-simple-guaranteed-pubsub/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceTraining/solace-simple-guaranteed-pubsub) and clone your fork
locally.
...
```sh
$ git remote add upstream https://github.com/SolaceTraining/solace-simple-guaranteed-pubsub
```
...
In GitHub, send a pull request to `solace-simple-guaranteed-pubsub:master`.
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceTraining/solace-simple-guaranteed-pubsub/issues/new) and describe the new functionality.
